...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,378 | 🐛 106 | 📅 2026-09-02 list thing.
...
* [giscus](https://github.com/laymonage/giscus) ⭐ 12,096 | 🐛 127 | 🌐 TypeScript | 📅 2026-05-26 - A comments widget built on GitHub Discussions.
...
* [Utterences](https://github.com/utterance/utterances) ⭐ 9,690 | 🐛 172 | 🌐 TypeScript | 📅 2024-08-15 - A lightweight comments widget built on GitHub issues.
...
* [minisearch](https://github.com/lucaong/minisearch) ⭐ 6,136 | 🐛 13 | 🌐 TypeScript | 📅 2025-09-16 - Tiny and powerful JavaScript full-text search engine for browser and Node
...
* [search-index](https://github.com/fergiemcdowall/search-index) ⭐ 1,421 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-02 - A persistent, network resilient, full text search library for the browser and Node.js

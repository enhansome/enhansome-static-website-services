...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,270 | 🐛 100 | 📅 2026-06-30 list thing.
...
* [1Backend](https://github.com/1backend/1backend) ⭐ 2,340 | 🐛 1 | 🌐 Go | 📅 2026-05-27 - Deploy your backend in seconds. Free tier included. Open source.
...
* [giscus](https://github.com/laymonage/giscus) ⭐ 12,019 | 🐛 125 | 🌐 TypeScript | 📅 2026-05-26 - A comments widget built on GitHub Discussions.
...
* [Utterences](https://github.com/utterance/utterances) ⭐ 9,694 | 🐛 173 | 🌐 TypeScript | 📅 2024-08-15 - A lightweight comments widget built on GitHub issues.
...
* [flexsearch](https://github.com/nextapps-de/flexsearch) ⭐ 13,773 | 🐛 36 | 🌐 JavaScript | 📅 2026-06-28 - Next-Generation full text search library for Browser and Node.js
* [minisearch](https://github.com/lucaong/minisearch) ⭐ 6,091 | 🐛 13 | 🌐 TypeScript | 📅 2025-09-16 - Tiny and powerful JavaScript full-text search engine for browser and Node
* [tinysearch](https://github.com/tinysearch/tinysearch) ⭐ 2,954 | 🐛 6 | 🌐 Rust | 📅 2026-02-03 - Tiny, full-text search engine for static websites built with Rust and Wasm
...
* [search-index](https://github.com/fergiemcdowall/search-index) ⭐ 1,423 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-12 - A persistent, network resilient, full text search library for the browser and Node.js
* [fuzzy](https://github.com/mattyork/fuzzy) ⭐ 835 | 🐛 29 | 🌐 JavaScript | 📅 2021-12-20 - Fuzzy search / filter for browser and node
* [itemsjs](https://github.com/itemsapi/itemsjs) ⭐ 403 | 🐛 0 | 🌐 JavaScript | 📅 2025-11-25 - Full text, faceted, almost dependency free search engine in javascript

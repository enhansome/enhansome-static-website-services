...
* [giscus](https://github.com/laymonage/giscus) ⭐ 12,042 | 🐛 126 | 🌐 TypeScript | 📅 2026-05-26 - A comments widget built on GitHub Discussions.
...
* [flexsearch](https://github.com/nextapps-de/flexsearch) ⭐ 13,776 | 🐛 36 | 🌐 JavaScript | 📅 2026-06-28 - Next-Generation full text search library for Browser and Node.js
* [minisearch](https://github.com/lucaong/minisearch) ⭐ 6,099 | 🐛 13 | 🌐 TypeScript | 📅 2025-09-16 - Tiny and powerful JavaScript full-text search engine for browser and Node
* [tinysearch](https://github.com/tinysearch/tinysearch) ⭐ 2,960 | 🐛 3 | 🌐 Rust | 📅 2026-08-15 - Tiny, full-text search engine for static websites built with Rust and Wasm
...
* [search-index](https://github.com/fergiemcdowall/search-index) ⭐ 1,422 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-19 - A persistent, network resilient, full text search library for the browser and Node.js
